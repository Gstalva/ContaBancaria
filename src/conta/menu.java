...
public class menu {
    public static void main(String[] args) {
    	...
    	ContaCorrente cp1 = new ContaCorrente(contas.gerarNumero(),125, 1, "Mariana dos Santos", 4000f, 12);
    	contas.cadastrar(cp1);
    	
    	ContaCorrente cp2 = new ContaCorrente(contas.gerarNumero(),126, 1, "Juliana ramos", 8000f, 15);
